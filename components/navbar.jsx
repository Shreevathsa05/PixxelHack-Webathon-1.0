...
export default function Navbar() {
  ...
  return (
    <div className="flex justify-center">
      <nav className="w-[70%] bg-black bg-opacity-90 shadow-[0_0_20px_rgba(6,182,212,0.8)] text-gray-500 px-4 rounded-3xl mx-4 mt-8">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between px-6 py-4">
          <Link href="/" className="flex items-center space-x-4">
            <img src="/favicon.ico" className="w-14 h-14" alt="LootKart Logo" />
            ...
            <ul className="font-medium flex flex-col md:flex-row md:space-x-8 mt-4 md:mt-0">
              {[
                ...
                <li key={label}>
                  <Link
                    href={path}
                    className={`block py-2 px-3 rounded md:p-0 ${pathname === path
